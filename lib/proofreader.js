...
Proofreader.prototype.proofread = function (html) {
  ...
  // Configure the proofreader (a bit of a hack from the original source)
  this.setWhitelist("p, li, h1, h2, h3, h4, th, td, dl, figcaption");
  this.setBlacklist("pre, code");
  this.addDictionary(
    path.join(__dirname, '../dictionaries/en_US.dic'),
    path.join(__dirname, '../dictionaries/en_US.aff'));
